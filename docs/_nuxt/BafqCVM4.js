import{$t as e,A as t,F as n,G as r,H as i,I as a,L as o,Pt as s,R as c,U as l,Z as u,bt as d,ft as f,i as p,lt as m,nn as h,r as g,st as _,yt as v,z as y}from"./nW5eDnH9.js";import{a as b,i as x,n as S,o as C,r as w,t as T}from"./Ca1DtwEh.js";import{t as E}from"./Bxc0cDnT.js";import{t as D}from"./DVKH0yU3.js";import{t as O}from"./J6LhE9C0.js";var k=[{value:`spinner`,label:`Spinner`},{value:`dots`,label:`Bouncing Dots`},{value:`bars`,label:`Bars`},{value:`ring`,label:`Dual Ring`},{value:`pulse`,label:`Pulse`},{value:`progress`,label:`Progress Bar`},{value:`skeleton`,label:`Skeleton Shimmer`},{value:`wave`,label:`Wave Bars`},{value:`orbit`,label:`Orbit Dots`},{value:`ripple`,label:`Ripple`},{value:`square`,label:`Square Morph`}],A={kind:`spinner`,color:`#10b981`,trackColor:`#27272a`,size:48,thickness:4,speed:.8,count:3,progress:60};function j(e){return`loader-${e}`}function M(e){let t=j(e.kind);switch(e.kind){case`spinner`:return`.${t} {
  width: ${e.size}px;
  height: ${e.size}px;
